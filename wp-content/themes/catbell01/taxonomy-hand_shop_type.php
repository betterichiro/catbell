  ...
  <section class="catList">
    <div class="catList__inner inner">
      ...
      <div class="catList__head">
        <h2 class="catList__title"><?php echo single_term_title(); ?></h2>
      </div>
      ...
      ?>
        ...
        <?php endwhile; ?>
        <?php else : ?>
          <p style="font-size: 18px;">該当する猫ちゃんが見つかりませんでした。</p>
          <?php endif; ?>
      </ul>
      ...
      <div class="about__store">
        <?php
          ...
          $term_idsp = 'hand_shop_type_' . $term_id; //タクソノミーの名前 + term_id
        ...
        <div class="about__store__body">
          ...
          <dl class="about__store__content">
            ...
            <dt>営業時間</dt>
            <dd><?php echo get_post_meta($post_object, 'shop_hours', true); ?><br>
              休日：年中無休</dd>
          </dl>
